...
|------------------|-------------------------------------------------|-------------------------------------|-----------------------------------|
| Multithreading   | 3 -> 1 -> 4 -> 2 -> 8 -> 6 -> 7 -> 5 (Random)   |  2.12, 82.38, 83.00, 96.25, 75.62   | Average = 0.5144 ÷ 5 = 0.10288    |
| Multiprocessing  | 0 -> 1 -> 3 -> 2 -> 4 -> 5 -> 7 -> 6 (Parallel) |  2.125, 88.75, 91.00, 84.00, 76.25  | Average = 1.935093 ÷ 5 = 0.387019 |
...
6. How did your group apply creative coding or algorithmic solutions in thislab?    
